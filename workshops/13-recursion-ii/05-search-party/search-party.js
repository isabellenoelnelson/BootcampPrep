...
/* function searchParty(name, world) {
   // loop through the places in the world
    for (let place in world) {
        // if theres a person in this place
        ...
        // else if theres an array of people in this place
        ...
        // else there must be another object in this place
            ...
            // if we found the person in the next object
            if (resultFromNextObject) {
                // return a new array, with the current place concated in
                // front of the resultFromNextObject
